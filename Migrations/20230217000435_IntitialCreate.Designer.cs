...
namespace nscccoursemapBrennanHolmes.Migrations
{
    ...
    [Migration("20230217000435_IntitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSCCCourseMap.Models.Semester", b =>
                {
                    ...
                    b.HasIndex("Name", "StartDate", "EndDate", "AcademicYearId")
                        .IsUnique();
            ...
            modelBuilder.Entity("NSCCCourseMap.Models.CoursePrerequisite", b =>
                {
                    b.HasOne("NSCCCourseMap.Models.Course", "Courses")
                        .WithMany("Prerequisites")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("NSCCCourseMap.Models.Course", "Prerequisites")
